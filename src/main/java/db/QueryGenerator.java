...
public class QueryGenerator {
    private final static String INSERT_CUSTOMER_TEMPLATE = "INSERT INTO customers (name, age, city, balance, orders_count, \"group\") VALUES (?, ?, ?, ?, ?, ?);";
    private final static String INSERT_ORDER_TEMPLATE = "INSERT INTO orders (cost, delivery_address, outpost_address, order_date, customer_id, order_paid, order_sent, order_delivered, \"group\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
